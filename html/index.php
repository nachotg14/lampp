...
<body>
    <header class="bg-dark text-white d-flex justify-content-between align-items-center px-3 py-2">
        ...
        <!-- Change "ruta-del-logo.jpg" to the path of your image -->
        ...
        if (isset($_COOKIE['cookie_id'])) {
            ...
            if ($stmt->rowCount() == 1) {
                ...
                echo '<a class="dropdown-item" href="borrarcookie.php">Cerrar Sesión</a>';
                echo '</div>';
                echo '</div>';
            }
        } else {
        ...
        function guardarNoticia() {
            ...
            $.ajax({
                ...
                error: function(xhr, status, error) {
                    alert("Error al guardar la noticia: " + error);
                }
            });
        }
    </script>
